...
// File contracts/guardians/eth-polygon-guardians/KPL1FxTunnel.sol
...
// File contracts/guardians/eth-polygon-guardians/KPL1GuardianNFT.sol
 ...
 * @title FxStateRootTunnel
 */
contract KPL1GuardianNFT is AccessControl, ERC721URIStorage, ERC721Enumerable {
    ...
    constructor(address _daoTreasury) ERC721("PPGUARD", "PPG") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
    ...
    function awakenGuardian(string memory _tokenURI) external payable {
        require(totalSupply() < 87);
        require(balanceOf(msg.sender) == 0);
        require(msg.value >= 0.088 ether, "0.088 ether");

        if(!earlyBirds[msg.sender]) {
            require(msg.value >= 0.88 ether, "0.88 ether");
        }
    ...
    function addEarlyBird(address _earlyBirdAddress) external onlyRole(DEFAULT_ADMIN_ROLE) {
...
// File contracts/guardians/eth-polygon-guardians/KPL2AFxTunnel.sol

pragma solidity ^0.8.0;


interface IKPGuardian {
    function awakenTribe(uint tokenId) external;
}
...
contract KPL2AFxTunnel is AccessControl, FxBaseChildTunnel {
    ...
    event AwakenTheMinions(uint tokenId, string tokenURIFromRoot);
        ...
        validateSender(sender) 
    {
        ...
        (uint tokenId, string memory tokenURIFromRoot) = abi.decode(data,(uint,string));

        emit AwakenTheMinions(tokenId, tokenURIFromRoot);

        guardian.awakenTribe(tokenId);
    }

    function setKPChild(IKPGuardian _kpGuardian) external onlyRole(DEFAULT_ADMIN_ROLE) {
        guardian = _kpGuardian;
...
// File contracts/guardians/eth-polygon-guardians/KPL2AGuardianNFT.sol
...
contract KPL2AGuardianNFT is AccessControl, ERC721URIStorage, ERC721Enumerable {
        ...
        ERC721("PPGUARD", "PPG") 
    {
        ...
        daoTreasury = _daoTreasury;
        _connectedToken = L1TokenAddress;
    ...
    */
    function awakenTribe(uint guardianId) external onlyRole(L2A_TUNNEL_ROLE) {
...
// File contracts/tokens/IFxERC1155.sol
...
// File contracts/tokens/FxERC1155.sol
...
contract FxERC1155 is ERC1155, IFxERC1155 {
    ...
    function mintBatch(address user, uint256[] memory ids, uint256[] memory amounts, bytes memory data) public override{
        require(msg.sender == _fxManager, "Invalid sender");
...
// File contracts/tokens/FxERC20.sol
...
// File contracts/tokens/FxERC721.sol
